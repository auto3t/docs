...
Movie release windows represent when and on what medium a movie is released. That is provided by themoviedb. These dates are used by **Auto3T** to determine when to start searching for a movie.
...
| Archived          | a                 | The movie has been identified by the mediaserver.                                                 |
| Ignored           | i                 | The movie has been ignored and will not be searched automatically.                                |
