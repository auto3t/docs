...
Categories are the upper level hierarchy of how you want to group keywords together. Categories are used to determin which keyword is a *default* keyword, and which keyword is an *overwrite* keyword.


## Keywords

Keywords are defined on the category. For example you might want to create:
...
| Codec                 | x264, x265            | Selectively overwrite some popular shows to prefere x265 for higher compression rate. |
