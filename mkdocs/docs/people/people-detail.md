...
- Locking a person blocks a person from getting deleted if they don't have any credits. Manually added persons are locked by default.
...
Credits from this person on remote indexes. Remote credits are only available if the person has the corresponding ID defined.
